...
- Add DTOs to decouple entities from API responses
- Introduce validation with Bean Validation
- Add pagination and filtering endpoints
- Create integration tests for the REST API
- Add Swagger / OpenAPI documentation
- Configure separate profiles for PostgreSQL and production
- Add authentication and authorization with Spring Security

## Author

Project created as part of a personal learning journey in **JPA/Hibernate and Spring Boot**.

If you want, I can also help transform this repository README into a more portfolio-oriented version with:
